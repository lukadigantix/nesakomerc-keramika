        ...
        <Wrapper>
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-px bg-zinc-100">
            {stats.map(({ icon: Icon, vrednost, oznaka }) => (
              <div key={oznaka} className="flex flex-col items-center gap-3 px-6 py-8 text-center group cursor-default bg-white sm:bg-transparent">
      ...
      <div className="py-12 lg:py-16 bg-white border-b border-zinc-100">
        <Wrapper>
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-10 items-start">
            ...
            <div className="lg:col-span-7 lg:col-start-6 grid grid-cols-1 sm:grid-cols-2 gap-4 lg:gap-6">
              {[
